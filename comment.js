  ...
  snapshot.docs.forEach((docSnapshot, index) => {
    ...
    item.innerHTML = `
      <div class="comment-header">
        <span class="comment-number">#${commentNo}</span>
...
// 5. コメント投稿処理
document.getElementById("commentForm")?.addEventListener("click", function(e){}); // 誤作動防止
